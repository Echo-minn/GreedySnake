...
Speed.prototype.speedup = function () {
    if (this.initspeed >= 50) {
        this.initspeed = this.initspeed - 20;
    }
};
Speed.prototype.slowdown = function () {
    if (this.initspeed <= 250) {
        this.initspeed = this.initspeed + 20;
    }
};
speed = new Speed();
...
//调整速度
let jiasu = document.getElementById('jiasu');
let jiansu = document.getElementById('jiansu');
jiasu.onclick = function (message) {
    speed.speedup();
